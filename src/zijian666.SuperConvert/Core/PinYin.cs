namespace zijian666.SuperConvert.Core
{
    static class PinYin
    {
        ...
        public static string[] CharNames { get; } =
        {
        ...
        /// 二级汉字数组
        /// </summary>
        private static readonly char[] _chinese =
        {
        ...
        private static readonly string[] _map = BuildMap();

        private static string[] BuildMap()
        {
            var map = new string[char.MaxValue];
            for (var i = 0; i < _chinese.Length; i++)
            {
                map[_chinese[i]] = _pinyin[i];
            }
            return map;
        }

        public static string Map(char c) => _map[c];
    }
}
