...
namespace zijian666.SuperConvert.Convertor.Base
{
    ...
    public abstract class BaseConvertor<T> : Convertor<T>, IConvertor<T>
    {
        ...
        protected delegate ConvertResult<T> InvokeIFormHandler(BaseConvertor<T> convertor, IConvertContext context, object input);
