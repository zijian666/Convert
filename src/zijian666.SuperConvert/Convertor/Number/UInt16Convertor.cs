...
namespace zijian666.SuperConvert.Convertor
{
    ...
    /// </summary>
    public class UInt16Convertor : FromConvertor<ushort>
                                ...
                                , IFrom<byte[], ushort>
    {
        ...
        public ConvertResult<ushort> From(IConvertContext context, DateTime input) => context.ConvertFail(this, input);
